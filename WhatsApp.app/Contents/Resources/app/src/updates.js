(function() {
  var AutoUpdateManager, CHECKING_STATE, DOWNLOADING_STATE, ERROR_STATE, EventEmitter, IDLE_STATE, NO_UPDATE_AVAILABLE_STATE, UPDATE_AVAILABLE_STATE, autoUpdater, dialog,
  ...
  module.exports = AutoUpdateManager = (function(_super) {
    __extends(AutoUpdateManager, _super);
    ...
    function AutoUpdateManager(version) {
      ...
      autoUpdater.setFeedUrl("https://whatsappweb-updates.herokuapp.com/api/updates?version=" + this.version);
